...
public:
	void init() {
		...
		std::string filename = "resnet50_worker_" + std::to_string(FAST::rank()) + "_batch_" + std::to_string(batch_size_) ;
...
//		}
		...
		args = mxnet::cpp::NDArray::LoadToMap("../initialized_weights/resnet50_cifar10_init"+std::to_string(batch_size_)+".bin");
